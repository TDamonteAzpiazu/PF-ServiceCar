  ...
  return (
    <div
      className={`relative   px-3 mb-9 shadow-md ${
        carrusel
          ? "md:min-w-[32.8%] sm:min-w-[50%] min-w-full rounded pb-6 pt-[68px]"
          : "md:w-full w-11/12 mx-auto rounded-xl py-6"
      } md:w-full w-11/12 mx-auto max-h-[600px] text-custom-white  ${
